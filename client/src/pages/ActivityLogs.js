      ...
      <div style={{ display: 'flex', gap: 10, marginBottom: 12, alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button
            ...
            style={{ background: typeFilter === '' ? '#2e7d32' : '#e0f2f1', color: typeFilter === '' ? '#fff' : '#1a1a1a' }}
          >
            All
          </button>
          <button
            ...
            style={{ background: typeFilter === 'login' ? '#2e7d32' : '#e0f2f1', color: typeFilter === 'login' ? '#fff' : '#1a1a1a' }}
          >
            Login
          </button>
          <button
            ...
            style={{ background: typeFilter === 'logout' ? '#2e7d32' : '#e0f2f1', color: typeFilter === 'logout' ? '#fff' : '#1a1a1a' }}
          >
            Logout
          </button>
        </div>
